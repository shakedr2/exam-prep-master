      ...
      <div className="min-h-screen pb-24 pt-4">
        <div className="mx-auto max-w-2xl px-4 space-y-6">
          ...
          <div className="grid grid-cols-3 gap-2 sm:gap-3">
            {[0, 1, 2].map((i) => (
              <div key={i} className="rounded-lg border border-foreground/10 bg-card p-3 space-y-1.5">
          ...
          <div className="space-y-3">
            ...
            <div className="rounded-lg border border-foreground/10 p-3 space-y-3">
              ...
              <div className="grid grid-cols-2 gap-3">
                {[0, 1, 2, 3].map((i) => (
                  <div key={i} className="rounded-lg border border-foreground/10 bg-card p-4 space-y-3">
                    <div className="flex items-center justify-between">
