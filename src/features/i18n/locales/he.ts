...
const he = {
  ...
  auth: {
    ...
    login: {
      title: "התחברות",
      subtitle: "התחבר כדי לשמור את ההתקדמות שלך",
      googleCta: "התחבר עם Google",
      or: "או",
      loading: "מתחבר...",
      submit: "התחבר",
      forgotPassword: "שכחת סיסמה?",
      magicLinkCta: "התחברות עם קישור חד-פעמי",
      noAccount: "אין לך חשבון?",
      register: "הרשמה",
      continueAsGuest: "המשך בלי חשבון ←",
    },
    magicLink: {
      emailLabel: "אימייל לקבלת קישור",
      description: "נשלח אליך קישור התחברות חד-פעמי למייל.",
      submit: "שלח קישור התחברות",
      success: "בדוק את המייל שלך — שלחנו לך קישור התחברות",
      resendIn: "שלח שוב בעוד {{seconds}} שניות",
      backToPassword: "חזרה להתחברות עם סיסמה",
    },
    register: {
      title: "הרשמה",
      subtitle: "צור חשבון כדי לשמור את ההתקדמות שלך",
      ...
      successBody: "שלחנו לך אימייל לאישור. בדוק את תיבת הדואר שלך.",
      backToLogin: "חזרה להתחברות",
    },
    forgotPassword: {
      title: "איפוס סיסמה",
      subtitle: "הזן את האימייל שלך ונשלח קישור לאיפוס סיסמה.",
      submit: "שלח קישור לאיפוס",
      success: "בדוק את המייל שלך — שלחנו לך קישור לאיפוס סיסמה",
      backToLogin: "חזרה להתחברות",
    },
    resetPassword: {
    ...
    validation: {
      passwordMin: "הסיסמה חייבת להכיל לפחות {{min}} תווים",
      passwordMinHint: "לפחות {{min}} תווים",
