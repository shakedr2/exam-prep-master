...
print(mystery(4321).strip())`,
  ...
  // ── OOP: Classes & Objects ───────────────────────────
  {
    id: "classes_objects_1",
    type: "quiz",
    topic: "classes_objects",
    difficulty: "easy",
    question: "מה תפקיד המתודה __init__ במחלקה בפייתון?",
    options: [
      "היא הבנאי — נקראת אוטומטית בעת יצירת מופע חדש ומאתחלת את התכונות",
      "היא מתודה שמוחקת את האובייקט מהזיכרון",
      "היא מדפיסה את כל תכונות האובייקט",
      "היא מתודה פרטית שלא ניתן לקרוא לה מבחוץ",
    ],
    correctIndex: 0,
    explanation: "__init__ היא מתודת האתחול (constructor). היא נקראת אוטומטית בכל פעם שיוצרים מופע חדש ומשמשת להגדרת התכונות ההתחלתיות דרך self.",
    patternFamily: "class_basics",
    commonMistake: "לחשוב ש-__init__ מחזירה את המופע. בפועל __init__ תמיד מחזירה None; פייתון מטפלת ביצירה בנפרד.",
  },
  {
    id: "classes_objects_2",
    type: "quiz",
    topic: "classes_objects",
    difficulty: "easy",
    question: "מה מייצג הפרמטר self בתוך מתודה של מחלקה?",
    options: [
      "את שם המחלקה עצמה",
      "משתנה גלובלי השמור לכל המופעים",
      "את המופע הנוכחי של המחלקה שעליו נקראה המתודה",
      "מילה שמורה שחייבים לקרוא לה בדיוק self",
    ],
    correctIndex: 2,
    explanation: "self הוא הפרמטר הראשון של כל מתודה ומתייחס למופע הספציפי שעליו נקראה המתודה. דרכו ניגשים לתכונות המופע (self.name) ולמתודות אחרות שלו.",
    patternFamily: "class_basics",
    commonMistake: "לשכוח את self ברשימת הפרמטרים של המתודה — ייצור TypeError בקריאה.",
  },
  {
    id: "classes_objects_3",
    type: "tracing",
    topic: "classes_objects",
    difficulty: "medium",
    question: "מה יודפס?",
    ...
    correctAnswer: "רקס",
    explanation: "יצרנו מופע Dog עם הארגומנט \"רקס\". ב-__init__ שמרנו אותו ל-self.name, ולכן d.name מחזיר \"רקס\".",
    patternFamily: "class_state",
    commonMistake: "לחשוב ש-self.name = name יוצר משתנה מקומי. בפועל זה שומר תכונה על המופע.",
  },
  {
    id: "classes_objects_4",
    type: "tracing",
    topic: "classes_objects",
    difficulty: "medium",
    question: "מה יודפס?",
    code: "class Counter:\n    count = 0\n    def __init__(self):\n        Counter.count += 1\n\na = Counter()\nb = Counter()\nc = Counter()\nprint(Counter.count)",
    correctAnswer: "3",
    explanation: "count היא תכונת מחלקה (class attribute) משותפת לכל המופעים. כל קריאה ל-__init__ מגדילה אותה ב-1. יצרנו 3 מופעים, ולכן Counter.count = 3.",
    patternFamily: "class_attributes",
    commonMistake: "לבלבל בין תכונת מחלקה (משותפת) לבין תכונת מופע (ייחודית לאובייקט).",
  },
  {
    id: "classes_objects_5",
    type: "fill-blank",
    topic: "classes_objects",
    difficulty: "hard",
    title: "השלם מתודה של חישוב שטח",
    description: "השלם את המתודה area כך שתחזיר את שטח המלבן.",
    code: "class Rect:\n    def __init__(self, w, h):\n        self.w = w\n        self.h = h\n    def area(self):\n        return ____ * self.h\n\nr = Rect(3, 4)\nprint(r.area())",
    blanks: [{ answer: "self.w", hint: "שדה המופע שמייצג את רוחב המלבן" }],
    solutionExplanation: "area ניגשת לתכונות המופע דרך self. שטח המלבן הוא self.w * self.h = 3 * 4 = 12.",
    patternFamily: "class_methods",
    commonMistake: "לכתוב w במקום self.w — ייזרק NameError כי w לא מוגדר בהיקף המקומי של המתודה.",
  },
  ...
  // ── OOP: Inheritance ─────────────────────────────────
  {
    ...
    topic: "inheritance",
    difficulty: "easy",
    question: "איך מגדירים בפייתון מחלקה Cat שיורשת ממחלקה Animal?",
    options: [
    ...
    correctIndex: 1,
    explanation: "בפייתון הירושה מצוינת בסוגריים אחרי שם המחלקה החדשה: class Cat(Animal). Cat יורשת אוטומטית את כל התכונות והמתודות של Animal.",
    patternFamily: "inheritance_syntax",
    commonMistake: "שימוש בתחביר של שפות אחרות כמו extends (Java) או : בלי סוגריים.",
  },
  {
    id: "inheritance_2",
    type: "quiz",
    topic: "inheritance",
    difficulty: "medium",
    question: "מה תפקיד super().__init__(...) במחלקה יורשת?",
    options: [
      "מוחק את המופע של המחלקה היורשת",
      "קורא ל-__init__ של מחלקת האב כדי לאתחל את התכונות שהיא מגדירה",
      "יוצר מופע חדש של מחלקת האב בנפרד",
      "משנה את מחלקת האם של האובייקט בזמן ריצה",
    ],
    correctIndex: 1,
    explanation: "super().__init__(...) קורא לבנאי של מחלקת האב כדי לאתחל את התכונות המוגדרות שם. זה חשוב כי אחרת התכונות של האב לא יאותחלו כשיוצרים מופע של הבן.",
    patternFamily: "inheritance_super",
    commonMistake: "לשכוח לקרוא ל-super().__init__ ואז לגלות שאין self.name או תכונות בסיס אחרות.",
  },
  {
    id: "inheritance_3",
    type: "tracing",
    ...
    code: 'class Animal:\n    def speak(self):\n        return "some sound"\n\nclass Dog(Animal):\n    def speak(self):\n        return "woof"\n\nd = Dog()\nprint(d.speak())',
    correctAnswer: "woof",
    explanation: "Dog דורסת (overrides) את speak של Animal. כאשר קוראים ל-d.speak() פייתון מוצאת את המימוש בתוך Dog ולכן מחזירה \"woof\".",
    patternFamily: "inheritance_override",
    commonMistake: 'לחשוב שהמתודה של האב תיקרא כי היא הוגדרה ראשונה.',
  },
  {
    id: "inheritance_4",
    type: "tracing",
    ...
    code: 'class A:\n    def __init__(self):\n        self.x = 1\n\nclass B(A):\n    def __init__(self):\n        super().__init__()\n        self.y = 2\n\nb = B()\nprint(b.x, b.y)',
    correctAnswer: "1 2",
    explanation: "super().__init__() קורא ל-A.__init__ שמציב self.x = 1, ולאחר מכן B.__init__ מוסיפה self.y = 2. לכן b.x = 1 ו-b.y = 2.",
    patternFamily: "inheritance_super",
    commonMistake: "לשכוח super() ולקבל AttributeError על b.x.",
  },
  {
    id: "inheritance_5",
    type: "fill-blank",
    topic: "inheritance",
    difficulty: "hard",
    title: "השלם קריאה ל-super",
    description: "השלם את הקריאה לבנאי האב כך ש-Employee יאתחל את name מ-Person.",
    code: 'class Person:\n    def __init__(self, name):\n        self.name = name\n\nclass Employee(Person):\n    def __init__(self, name, salary):\n        ____.__init__(name)\n        self.salary = salary\n\ne = Employee("דנה", 5000)\nprint(e.name, e.salary)',
    blanks: [{ answer: "super()", hint: "קריאה למחלקת האב דרך פונקציית helper" }],
    solutionExplanation: "super().__init__(name) קורא ל-Person.__init__ כדי להציב self.name, ואז מוסיפים self.salary ב-Employee.",
    patternFamily: "inheritance_super",
    commonMistake: "לכתוב Person.__init__(name) בלי self — יזרק שגיאה.",
  },
  ...
  // ── OOP: Polymorphism ────────────────────────────────
  {
    ...
    topic: "polymorphism",
    difficulty: "easy",
    question: "מה המשמעות של duck typing בפייתון?",
    options: [
      "הטיפוס של אובייקט נקבע לפי הממשק שלו (המתודות שהוא תומך בהן) ולא לפי ירושה מפורשת",
      "צריך להכריז על טיפוסים בצורה מפורשת לפני השימוש",
      "כל אובייקט חייב לרשת ממחלקת Duck",
      "רק אובייקטים מאותה מחלקה יכולים להיות פולימורפיים",
    ],
    correctIndex: 0,
    explanation: 'Duck typing: "אם זה נראה כמו ברווז ומגעגע כמו ברווז — זה ברווז". בפייתון מה שחשוב זה איזה מתודות יש לאובייקט, לא מאיזו מחלקה הוא יורש.',
    patternFamily: "polymorphism_duck",
    commonMistake: "לחשוב שבהכרח צריך ירושה או ממשק מוגדר פורמלית לפולימורפיזם.",
  },
  {
    id: "polymorphism_2",
    type: "quiz",
    topic: "polymorphism",
    difficulty: "medium",
    question: "מה תפקיד המודול abc וההחלטה @abstractmethod?",
    options: [
      "מאפשר להגדיר מחלקות בסיס אבסטרקטיות שכל תת-מחלקה חייבת לממש מתודות מסוימות",
      "יוצר העתק עמוק של אובייקטים",
      "בודק אם שני אובייקטים שווים",
      "מגדיר מחלקות פרטיות שלא ניתן ליצור מהן מופע",
    ],
    correctIndex: 0,
    explanation: "abc.ABC + @abstractmethod מאפשרים להגדיר 'חוזה' — מחלקות יורשות חייבות לממש את המתודות המסומנות כאבסטרקטיות, אחרת לא ניתן ליצור מופע שלהן.",
    patternFamily: "polymorphism_abc",
    commonMistake: "לשכוח לרשת מ-ABC ועדיין לחשוב שהמתודה 'אבסטרקטית'.",
  },
  {
    id: "polymorphism_3",
    type: "tracing",
    ...
    correctAnswer: "woof\nmeow",
    explanation: "זו דוגמה קלאסית ל-duck typing: הלולאה קוראת ל-sound() על כל אובייקט, ופייתון מזהה את המתודה הנכונה לפי טיפוס האובייקט בזמן ריצה.",
    patternFamily: "polymorphism_duck",
    commonMistake: "לחשוב שצריך בסיס משותף — מספיק שיש מתודה sound() לכל אחד.",
  },
  {
    id: "polymorphism_4",
    type: "tracing",
    ...
    correctAnswer: "9",
    explanation: "Shape().area() = 0, Square(3).area() = 3² = 9. סכום = 0 + 9 = 9. כל אובייקט משתמש במימוש המתאים לטיפוס שלו בזמן ריצה.",
    patternFamily: "polymorphism_override",
    commonMistake: "להניח ש-Shape.area תמיד תיקרא — דריסה במחלקה יורשת מנצחת.",
  },
  {
    id: "polymorphism_5",
    type: "fill-blank",
    topic: "polymorphism",
    difficulty: "hard",
    title: "השלם מתודה אבסטרקטית",
    description: "השלם את הדקורטור כדי לסמן את area כמתודה אבסטרקטית שחייבים לממש.",
    code: "from abc import ABC, abstractmethod\n\nclass Shape(ABC):\n    @____\n    def area(self):\n        pass\n\nclass Circle(Shape):\n    def __init__(self, r):\n        self.r = r\n    def area(self):\n        return 3.14 * self.r ** 2",
    blanks: [{ answer: "abstractmethod", hint: "הדקורטור מהמודול abc שמחייב מימוש במחלקה יורשת" }],
    solutionExplanation: "@abstractmethod מסמן ש-area חייבת להיות ממומשת בכל תת-מחלקה, אחרת יזרק TypeError ביצירת מופע.",
    patternFamily: "polymorphism_abc",
    commonMistake: "לשכוח לרשת מ-ABC — אז @abstractmethod לא אוכף את המימוש.",
  },

  // ── OOP: Decorators & Special Methods ────────────────
  {
    id: "decorators_special_1",
    type: "quiz",
    topic: "decorators_special",
    difficulty: "easy",
    question: "מה תפקיד המתודה __str__ במחלקה?",
    options: [
      "מוחקת את המופע מהזיכרון",
      "מגדירה כיצד ייראה האובייקט כאשר מדפיסים אותו עם print או str()",
      "משווה בין שני מופעים",
      "מגדירה את שם המחלקה",
    ],
    correctIndex: 1,
    explanation: "__str__ נקראת כאשר משתמשים ב-print(obj) או str(obj). היא מחזירה מחרוזת שמייצגת את האובייקט בצורה קריאה למשתמש.",
    patternFamily: "dunder_str",
    commonMistake: "לבלבל בין __str__ (קריא למשתמש) ל-__repr__ (קריא למפתח לצורכי דיבוג).",
  },
  {
    id: "decorators_special_2",
    type: "quiz",
    topic: "decorators_special",
    difficulty: "medium",
    question: "מה עושה הדקורטור @property?",
    options: [
      "הופך מתודה לתכונה שניתן לגשת אליה ללא סוגריים, מאפשר getter עם לוגיקה",
      "מסמן את המתודה כפרטית",
      "יוצר מופע משותף של המחלקה",
      "מגדיר שהמתודה תהיה תכונת מחלקה במקום תכונת מופע",
    ],
    correctIndex: 0,
    explanation: "@property הופך מתודה לגישה כאילו היא תכונה רגילה (obj.name במקום obj.name()). מאפשר להוסיף לוגיקה, ולידציה או חישוב בלי לשבור את ה-API.",
    patternFamily: "decorator_property",
    commonMistake: "לשים סוגריים בקריאה (obj.name()) — יזרוק TypeError כי התוצאה כבר אינה callable.",
  },
  {
    id: "decorators_special_3",
    type: "tracing",
    topic: "decorators_special",
    difficulty: "medium",
    question: "מה יודפס?",
    ...
    correctAnswer: "(3, 4)",
    explanation: "print(p) קורא ל-__str__ שמחזיר את המחרוזת f\"({self.x}, {self.y})\" עם הערכים 3 ו-4.",
    patternFamily: "dunder_str",
    commonMistake: "בלי __str__ היה מודפס משהו כמו <__main__.Point object at 0x...>.",
  },
  {
    id: "decorators_special_4",
    type: "tracing",
    topic: "decorators_special",
    difficulty: "hard",
    question: "מה יודפס?",
    ...
    correctAnswer: "True",
    explanation: "__eq__ מגדיר את התנהגות האופרטור ==. בדוגמה הוא משווה את amount, ושני האובייקטים עם amount=100 נחשבים שווים.",
    patternFamily: "dunder_eq",
    commonMistake: "בלי __eq__ היה מודפס False כי ברירת המחדל משווה זהות בזיכרון.",
  },
  {
    id: "decorators_special_5",
    type: "fill-blank",
    topic: "decorators_special",
    difficulty: "hard",
    title: "השלם @property",
    description: "השלם את הדקורטור המתאים כדי להפוך את full_name לתכונה מחושבת.",
    code: 'class Person:\n    def __init__(self, first, last):\n        self.first = first\n        self.last = last\n\n    @____\n    def full_name(self):\n        return f"{self.first} {self.last}"\n\np = Person("דנה", "לוי")\nprint(p.full_name)',
    blanks: [{ answer: "property", hint: "דקורטור שהופך מתודה לתכונה" }],
    solutionExplanation: "@property מאפשר לגשת ל-p.full_name (ללא סוגריים) ולקבל מחרוזת מחושבת מהשדות.",
    patternFamily: "decorator_property",
    commonMistake: "לשכוח @property ולהיות חייב לקרוא p.full_name() עם סוגריים.",
  },
  ...
  // ── DevOps: Linux Basics ─────────────────────────────
  {
    ...
    topic: "linux_basics",
    difficulty: "easy",
    question: "מה עושה הפקודה pwd בטרמינל של לינוקס?",
    options: [
      "מציגה את הסיסמה של המשתמש הנוכחי",
      "מדפיסה את הנתיב המלא של תיקיית העבודה הנוכחית",
      "מחליפה את הסיסמה של המשתמש",
      "מציגה את רשימת המשתמשים במערכת",
    ],
    correctIndex: 1,
    explanation: "הפקודה pwd (print working directory) מדפיסה את הנתיב המלא של התיקייה בה אנחנו נמצאים כרגע (למשל /home/user/projects). זה שימושי כדי לדעת את מיקום העבודה הנוכחי לפני ביצוע פעולות על קבצים.",
    patternFamily: "linux_navigation",
    commonMistake: "לחשוב ש-pwd קשורה לסיסמאות. ראשי התיבות הם 'print working directory', לא 'password'.",
  },
  {
    id: "linux_basics_2",
    type: "quiz",
    topic: "linux_basics",
    difficulty: "easy",
    question: "איזה דגל (flag) של הפקודה ls מציג גם קבצים מוסתרים (כאלה שמתחילים בנקודה)?",
    options: [
      "ls -h",
      "ls -a",
      "ls -s",
    ...
    correctIndex: 1,
    explanation: "הדגל -a (all) מציג את כל הקבצים, כולל קבצים מוסתרים שמתחילים ב-. (למשל .bashrc, .git). בדרך כלל ls רגיל מסתיר אותם. הדגל -h משמש להצגת גדלים בפורמט קריא (KB, MB), -s להצגת גודל, ו-r להפוך סדר.",
    patternFamily: "linux_navigation",
    commonMistake: "לבלבל בין -a (all, כולל מוסתרים) ל-l (long, פורמט מפורט). משתמשים רבים משלבים ls -la כדי לראות הכל בפורמט מפורט.",
  },
  {
    id: "linux_basics_3",
    type: "quiz",
    topic: "linux_basics",
    difficulty: "medium",
    question: "משתמש נמצא בתיקייה /home/user/projects/app. מה תעשה הפקודה cd ..?",
    options: [
      "תעביר אותו ל-/home/user",
      "תעביר אותו ל-/home/user/projects",
      "תעביר אותו לתיקיית הבית (/home/user)",
      "תמחק את התיקייה הנוכחית",
    ],
    correctIndex: 1,
    explanation: "הפקודה cd .. עולה ברמה אחת מעלה בעץ התיקיות. אם אנחנו ב-/home/user/projects/app, אחרי cd .. נהיה ב-/home/user/projects. כדי לעלות שתי רמות צריך לכתוב cd ../.. , כדי להגיע לתיקיית הבית משתמשים ב-cd ~ או cd בלי ארגומנט.",
    patternFamily: "linux_navigation",
    commonMistake: "לחשוב ש-cd .. חוזרת לתיקיית הבית. היא עולה רק רמה אחת מעלה, לא יותר.",
  },
  {
    id: "linux_basics_4",
    type: "quiz",
    topic: "linux_basics",
    difficulty: "medium",
    question: "מה ההבדל בין נתיב מוחלט (absolute) לנתיב יחסי (relative) בלינוקס?",
    options: [
      "אין הבדל מעשי, שניהם זהים",
      "נתיב מוחלט מתחיל ב-/ ומתאר את המיקום מהשורש, נתיב יחסי מתחיל מהתיקייה הנוכחית",
      "נתיב מוחלט תמיד ארוך יותר, נתיב יחסי תמיד קצר יותר",
      "נתיב יחסי עובד רק על קבצים, מוחלט רק על תיקיות",
    ],
    correctIndex: 1,
    explanation: "נתיב מוחלט מתחיל ב-/ (שורש מערכת הקבצים), למשל /home/user/file.txt, והוא עובד מכל מקום. נתיב יחסי מתחיל מהתיקייה הנוכחית, למשל ./docs/file.txt או ../file.txt, ומשמעותו משתנה לפי היכן אנחנו נמצאים.",
    patternFamily: "linux_paths",
    commonMistake: "להניח שנתיב יחסי עובד מכל מקום. אם אני ב-/tmp ומשתמש ב-./file.txt אני מתייחס ל-/tmp/file.txt, לא לקובץ במיקום אחר.",
  },
  {
    id: "linux_basics_5",
    type: "quiz",
    topic: "linux_basics",
    difficulty: "hard",
    question: "בפלט של ls -l מופיעה השורה:\ndrwxr-xr-x 2 alice staff 4096 Apr 10 12:34 docs\nמה ניתן להסיק ממנה?",
    options: [
      "docs הוא קובץ רגיל בבעלות alice",
      "docs הוא תיקייה בבעלות המשתמש alice, בקבוצה staff, בגודל 4096 בתים",
      "docs הוא קישור סמלי (symlink)",
      "docs הוא קובץ הפעלה של 4096 בתים",
    ],
    correctIndex: 1,
    explanation: "האות הראשונה d מציינת שזו תיקייה (directory). rwxr-xr-x הן ההרשאות (בעלים: קריאה/כתיבה/הרצה, קבוצה ואחרים: קריאה/הרצה). המספר 2 הוא מספר הלינקים. alice הוא הבעלים, staff היא הקבוצה, 4096 הגודל בבתים, ו-docs השם.",
    patternFamily: "linux_ls_format",
    commonMistake: "לקרוא את האות הראשונה כחלק מההרשאות. האות הראשונה היא סוג: d לתיקייה, - לקובץ רגיל, l לקישור סמלי.",
  },

  // ── DevOps: File Permissions ─────────────────────────
  {
    id: "file_permissions_1",
    type: "quiz",
    topic: "file_permissions",
    difficulty: "easy",
    question: "בהרשאות קובץ בלינוקס, מה מייצגות האותיות r, w, x?",
    options: [
      "read (קריאה), write (כתיבה), execute (הרצה)",
      "root, world, extended",
      "remove (מחיקה), write (כתיבה), extract (חילוץ)",
      "read, wait, exit",
    ],
    correctIndex: 0,
    explanation: "r = read (קריאה), w = write (כתיבה), x = execute (הרצה). ההרשאות מוגדרות לשלוש קבוצות: הבעלים (owner), הקבוצה (group), ואחרים (others). לדוגמה rwxr-xr-x אומר שלבעלים יש הרשאה מלאה, ולקבוצה ולאחרים יש קריאה והרצה בלבד.",
    patternFamily: "permissions_basics",
    commonMistake: "לשכוח ש-x על תיקייה משמעותו הרשאה להיכנס לתיקייה (cd), לא להריץ אותה כתוכנית.",
  },
  {
    id: "file_permissions_2",
    type: "quiz",
    topic: "file_permissions",
    difficulty: "easy",
    question: "מה תפקידה של הפקודה chmod?",
    options: [
      "לשנות את הבעלים של קובץ",
      "לשנות את ההרשאות (permissions) של קובץ או תיקייה",
      "ליצור משתמש חדש במערכת",
      "להעתיק קובץ עם שינוי שם",
    ],
    correctIndex: 1,
    explanation: "chmod (change mode) משנה את הרשאות הגישה של קובץ או תיקייה. לדוגמה chmod +x script.sh נותן הרשאת הרצה, chmod 644 file.txt קובע הרשאות ב-notation אוקטלי. לשינוי בעלים משתמשים ב-chown, לא ב-chmod.",
    patternFamily: "permissions_chmod",
    commonMistake: "לבלבל chmod (מצב/הרשאות) עם chown (change owner — שינוי בעלים).",
  },
  {
    id: "file_permissions_3",
    type: "quiz",
    topic: "file_permissions",
    difficulty: "medium",
    question: "מה משמעות הפקודה chmod 755 script.sh?",
    options: [
      "הבעלים: rwx, הקבוצה: rwx, אחרים: rwx",
      "הבעלים: rwx, הקבוצה: r-x, אחרים: r-x",
      "הבעלים: rw-, הקבוצה: r--, אחרים: r--",
      "הבעלים: r-x, הקבוצה: r-x, אחרים: r-x",
    ],
    correctIndex: 1,
    explanation: "כל ספרה בנוטציה האוקטלית מייצגת קבוצה אחת (בעלים/קבוצה/אחרים). כל ספרה היא סכום של r=4, w=2, x=1. 7 = 4+2+1 = rwx, 5 = 4+0+1 = r-x. לכן 755 = rwxr-xr-x — הבעלים יכול הכל, הקבוצה והאחרים יכולים לקרוא ולהריץ.",
    patternFamily: "permissions_octal",
    commonMistake: "לשכוח את מפת הסכום (r=4, w=2, x=1). המספר 6 למשל הוא 4+2 = rw-, לא rwx.",
  },
  {
    id: "file_permissions_4",
    type: "quiz",
    topic: "file_permissions",
    difficulty: "medium",
    question: "מה עושה הפקודה chown alice:devs report.txt?",
    options: [
      "מעתיקה את report.txt למשתמש alice",
      "משנה את בעלי הקובץ ל-alice ואת הקבוצה ל-devs",
      "יוצרת משתמש בשם alice בקבוצה devs",
      "מעניקה ל-alice הרשאת כתיבה לקובץ",
    ],
    correctIndex: 1,
    explanation: "chown (change owner) מאפשר לשנות את הבעלים של קובץ. התחביר user:group מגדיר גם בעלים (alice) וגם קבוצה (devs) בפקודה אחת. לרוב הפעולה דורשת הרשאות root (sudo chown ...).",
    patternFamily: "permissions_chown",
    commonMistake: "להשתמש ב-chmod כדי לשנות בעלות. chmod משנה הרשאות, chown משנה את הבעלים/קבוצה.",
  },
  {
    id: "file_permissions_5",
    type: "quiz",
    topic: "file_permissions",
    difficulty: "hard",
    question: "מה ההבדל העיקרי בין sudo ל-su?",
    options: [
      "אין הבדל, שתיהן פקודות זהות",
      "sudo מריצה פקודה אחת בהרשאות מוגברות עבור המשתמש הנוכחי, su מחליפה למשתמש אחר (ברירת מחדל root) לכל הסשן",
      "sudo משנה סיסמאות, su מוחקת משתמשים",
      "sudo מריצה רק סקריפטים, su רק פקודות interactive",
    ],
    correctIndex: 1,
    explanation: "sudo (superuser do) מריצה פקודה בודדת בהרשאות מוגברות ודורשת את הסיסמה של המשתמש הנוכחי (ותלויה בהגדרות /etc/sudoers). su (switch user) מחליפה להיות משתמש אחר — ברירת מחדל root — עד שמקלידים exit, ודורשת את הסיסמה של המשתמש שאליו עוברים. sudo בטוח יותר כי מתעד כל פעולה ולא דורש את סיסמת root.",
    patternFamily: "permissions_sudo",
    commonMistake: "להשאיר session של su root פתוח לאורך זמן. זה מסוכן כי כל פקודה רצה כ-root; עדיף sudo לפקודה ספציפית.",
  },
  ...
  // ── DevOps: Bash Scripting ───────────────────────────
  {
    id: "bash_scripting_1",
    type: "quiz",
    topic: "bash_scripting",
    difficulty: "easy",
    question: "מה עושה סימן הצינור | (pipe) ב-bash?",
    options: [
      "מפריד בין שתי פקודות שירוצו ברצף",
      "מעביר את הפלט (stdout) של הפקודה הראשונה כקלט (stdin) לפקודה השנייה",
      "מפנה את הפלט לקובץ",
      "מריץ את הפקודה ברקע",
    ],
    correctIndex: 1,
    explanation: "הצינור | מעביר את הפלט של פקודה אחת לקלט של פקודה אחרת. לדוגמה ls | grep .txt — ls מפיק רשימת קבצים, ו-grep מסנן רק את השורות שמכילות .txt. להפרדת פקודות משתמשים ב-; או &&, להפניה לקובץ ב-> , ולהרצה ברקע ב-&.",
    patternFamily: "bash_pipes",
    commonMistake: "לבלבל בין | (pipe — מעביר פלט לפקודה) ל-> (redirect — מפנה פלט לקובץ).",
  },
  {
    id: "bash_scripting_2",
    type: "quiz",
    topic: "bash_scripting",
    difficulty: "easy",
    question: "איזו הצהרה נכונה להגדרת משתנה בשם name עם הערך Alice בסקריפט bash?",
    options: [
      "name = Alice",
      "name=Alice",
      "let name = Alice",
    ...
    correctIndex: 1,
    explanation: "ב-bash מגדירים משתנה בלי רווחים סביב הסימן =. name=Alice הוא הנכון. הצורה name = Alice תיחשב כהרצת הפקודה 'name' עם הארגומנטים '=' ו-'Alice'. לשימוש במשתנה מוסיפים $, למשל echo $name.",
    patternFamily: "bash_variables",
    commonMistake: "להוסיף רווחים סביב ה-= (כמו ב-Python/JavaScript). ב-bash זה שובר את ההגדרה.",
  },
  {
    id: "bash_scripting_3",
    type: "quiz",
    topic: "bash_scripting",
    difficulty: "medium",
    question: "מה תעשה הפקודה grep -i error app.log?",
    options: [
      "תמחק את כל השורות שמכילות 'error' מהקובץ",
      "תמצא ותדפיס את כל השורות שמכילות 'error' (ללא הבדל רישיות) בקובץ app.log",
      "תחליף את המילה error במילה אחרת בקובץ",
      "תספור את מספר הופעות המילה error בקובץ",
    ],
    correctIndex: 1,
    explanation: "grep מחפשת תבנית בקובץ ומדפיסה את השורות שמתאימות. הדגל -i (ignore case) הופך את החיפוש ללא תלוי רישיות, כך ש-Error, ERROR ו-error כולם יימצאו. לספירת התאמות משתמשים ב--c, להיפוך (שורות שלא תואמות) ב--v.",
    patternFamily: "bash_grep",
    commonMistake: "לחשוב ש-grep משנה את הקובץ. grep רק מדפיסה שורות תואמות, היא לא עורכת. לעריכה משתמשים ב-sed.",
  },
  {
    id: "bash_scripting_4",
    type: "quiz",
    topic: "bash_scripting",
    difficulty: "medium",
    question: "מה יהיה הפלט של הסקריפט הבא?",
    code: "#!/bin/bash\ncount=3\nif [ $count -gt 2 ]; then\n  echo \"high\"\nelse\n  echo \"low\"\nfi",
    options: [
      "low",
      "high",
      "שגיאה — התחביר לא תקין",
      "high\\nlow",
    ],
    correctIndex: 1,
    explanation: "המשתנה count מוגדר כ-3. התנאי [ $count -gt 2 ] בודק אם count גדול מ-2. 3 > 2 זה אמת, ולכן הענף הראשון רץ ומדפיס 'high'. שימו לב לתחביר: רווחים סביב הסוגריים המרובעים, נקודה-פסיק לפני then, ו-fi לסגירת ה-if. אופרטורי השוואה לשלמים: -eq, -ne, -lt, -le, -gt, -ge.",
    patternFamily: "bash_conditionals",
    commonMistake: "להשתמש ב-> או >= להשוואת שלמים ב-bash. אופרטורים אלה מפנים פלט לקובץ. להשוואת שלמים חייב להשתמש ב--gt, -ge וכו'.",
  },
  {
    id: "bash_scripting_5",
    type: "quiz",
    topic: "bash_scripting",
    difficulty: "hard",
    question: "מה עושה הפקודה: cat access.log | grep 404 | wc -l",
    options: [
      "מחליפה את כל ה-404 בקובץ ב-wc",
      "סופרת את מספר השורות ב-access.log שמכילות את הטקסט 404",
      "מוחקת שורות עם 404 מהקובץ",
      "מציגה את 404 השורות הראשונות של הקובץ",
    ],
    correctIndex: 1,
    explanation: "זוהי שרשרת של שלוש פקודות המחוברות ב-pipes: (1) cat access.log מדפיסה את תוכן הקובץ. (2) grep 404 מסננת רק את השורות שמכילות 404. (3) wc -l סופרת את מספר השורות שהתקבלו. התוצאה: מספר השורות עם 404 בקובץ (שימושי למשל לספור שגיאות 404 ב-log שרת).",
    patternFamily: "bash_pipelines",
    commonMistake: "לבלבל בין wc -l (ספירת שורות) ל-wc -c (ספירת בתים) או wc -w (ספירת מילים).",
  },
];
